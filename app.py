...
EXERCISE_IMAGES = {
    ...
    # Nowe ćwiczenia
    "Wiosłowanie hantlem jednorącz w podporze o ławkę": "plecy-wioslowanie-hantlem.png",
...
EXERCISES = {
    ...
    "Wiosłowanie hantlem jednorącz w podporze o ławkę": {"color": "#FFEAA7", "description": "Mięsień czworoboczny (szczególnie część środkowa i dolna)"},
